-- Extensão de solicitação de compra
...
--
-- Table structure for table `d_sol_compra`
--

CREATE TABLE IF NOT EXISTS `d_sol_compra` (
...
(9, 'Solicitação de Compra', 'dsolcompra');
...
(9, 9, 'Solicitação de Compra', '/docinput/compras/Solicitacao');
