-- Extensão de caixas movimento financeiro
...
--
-- Table structure for table `d_caixa`
--

CREATE TABLE IF NOT EXISTS `d_caixa` (
...
(7, 7, 'Caixa Financeiro', '/docinput/financeiro/Caixa');
