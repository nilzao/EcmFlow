<?php
class knl_extensions_dnfsaida_dao extends knl_extensions_cadastronf_CadParent {
    private $conn;
    ...
    public function selectById($id) {
       ...
       if($l = $stmt->FetchRow()) {
          $objmodel = new knl_extensions_dnfsaida_model($l['id'],$l['id_doc'],$l['id_fornecedor'],$l['datasai']);
       } else {
            throw new Exception("Nenhum d_nf_saida foi encontrado!");
         }
       return $objmodel;
    }
    ...
    public function upsert(knl_extensions_dnfsaida_model $objmodel){
       if ($objmodel->get_id() == 0){
          $query = "INSERT INTO d_nf_saida (id_doc,id_fornecedor,datasai)
