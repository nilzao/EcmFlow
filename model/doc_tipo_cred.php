...
class knl_model_doc_tipo_cred {
     ...
     public function __construct($id,$id_doc_tipo,$id_knl_usuario,$id_knl_grupo,$perm_usuario,$perm_grupo,$perm_outros){
        $this->id = $id;
     ...
     public function getAllVars () {
         //$vars = get_class_vars(knl_dao_doc_tipo_cred);
         $vars = get_object_vars($this);
         foreach ($vars as $k => $v){
             $v = "get_$k";
             $varsZ['doc_tipo_cred_'.$k] = $this->$v();
         }
         return $varsZ;
     }
